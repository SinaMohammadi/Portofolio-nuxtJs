<template>
   <div class="flex flex-col sm:flex-row mb-8 justify-center gap-8 sm:gap-20">
                    <button class="skillCard">
                        ...
                        <h5 class="text-base">3 years as</h5>
                        <h3 class="text-3xl">Programmer</h3>                            
                    </button>
                    <button class="skillCard bg-purple-800 bg-opacity-30">
                        <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M10 14H54V44C54 44.5304 53.7893 45.0391 53.4142 45.4142C53.0391 45.7893 52.5304 46 52 46H42C41.4696 46 40.9609 45.7893 40.5858 45.4142C40.2107 45.0391 40 44.5304 40 44V38H24V52C24 52.5304 23.7893 53.0391 23.4142 53.4142C23.0391 53.7893 22.5304 54 22 54H12C11.4696 54 10.9609 53.7893 10.5858 53.4142C10.2107 53.0391 10 52.5304 10 52V14Z" stroke="#7B4AE2" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <h5 class="text-base">7 years of</h5>
                        <h3 class="text-3xl">Work</h3>                              
                    </button>
                    <button class="skillCard">
                        <svg width="76" height="64" viewBox="0 0 76 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M44 26C47.3137 26 50 23.3137 50 20C50 16.6863 47.3137 14 44 14C40.6863 14 38 16.6863 38 20C38 23.3137 40.6863 26 44 26Z" stroke="#7B4AE2" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M22 50C25.3137 50 28 47.3137 28 44C28 40.6863 25.3137 38 22 38C18.6863 38 16 40.6863 16 44C16 47.3137 18.6863 50 22 50Z" stroke="#7B4AE2" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M66 50C69.3137 50 72 47.3137 72 44C72 40.6863 69.3137 38 66 38C62.6863 38 60 40.6863 60 44C60 47.3137 62.6863 50 66 50Z" stroke="#7B4AE2" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M49.95 20.825C53.9094 21.9365 57.4785 24.1344 60.2533 27.1698C63.028 30.2052 64.8974 33.9569 65.65 38" stroke="#7B4AE2" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M22.35 38C23.1025 33.9569 24.972 30.2052 27.7467 27.1698C30.5214 24.1344 34.0905 21.9365 38.05 20.825" stroke="#7B4AE2" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <h5 class="text-base">4 years as</h5>
                        <h3 class="text-3xl">Designer</h3> 
                    </button>
                </div>
</template>