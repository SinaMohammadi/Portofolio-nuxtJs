<template>
  <div
    class="hidden sm:flex sm:flex-col items-center sm:items-end justify-between sm:justify-center"
  >
    <button class="flex text-purple-900 items-center">
      Baixar CV<svg
        width="16"
        height="16"
        viewBox="0 0 16 16"
    ...
    <button
      class="border border-solid border-purple-700 flex sm:mb-6 px-2.5 py-1 textColor-p fontweight-700"
    >
      <svg
        width="24"
        height="24"
